...
import { LogOut, Plus, Pencil, Trash2, Download, Users, Mail, Phone, MapPin, MessageCircle, Clock, LifeBuoy, FileText, Calendar, Star, DollarSign, Headphones, Settings, Menu, Key, Database, Lightbulb, Shield } from "lucide-react";
...
export default function Dashboard({ onLogout, userRole, userPermissions, userChapter, userTitle }) {
  ...
  // Helper to check permissions - NO admin bypass, all access controlled via Permission Panel
  ...
  const handleEdit = (member) => {
    ...
    setFormData({
      ...
      personal_email_private: member.personal_email_private || false,
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-white">Personal Email</TableHead>
