...
pdf.table_row(['National Officer', 'Chapter management, dues, tracking'], [45, 135])
...
pdf.body_text('The Dashboard provides a quick overview of the organization.')
...
pdf.bullet_item('Birthdays: Posted on members birthday')
...
pdf.chapter_title('Quick Reference - Status Colors', 2)
pdf.ln(3)
...
pdf.ln(20)
pdf.body_text('Document Version: 2.0 | Last Updated: February 2026')
pdf.body_text('BOH Hub - Member Management System')

# Save PDF
pdf.output('/app/frontend/public/BOH_Hub_Admin_Manual.pdf')
print("PDF generated successfully!")
print("Download at: https://themed-login-build.preview.emergentagent.com/BOH_Hub_Admin_Manual.pdf")
